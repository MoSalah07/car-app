    ...
    <>
      <Transition appear show={isOpen} as={Fragment}>
        <Dialog as="div" className={`relative z-10`} onClose={closeModel}>
          ...
          <div className="fixed inset-0 overflow-y-auto flex-center flex-col">
            <div className="flex min-h-full items-center p-4 text-center">
              ...
              >
                <Dialog.Panel
                  ...
                  overflow-y-auto transform rounded-2xl p-6 bg-white text-left shadow-xl transition-all flex flex-col gap-5`}
                >
                  <button
                    type="button"
                    onClick={closeModel}
